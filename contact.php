...
<body class="sub_page">
      ...
      <div class="container">
        <div class="top_contact-container">
          <div class="tel_container">
            <a href="">
              <img src="images/telephone-symbol-button.png" alt=""> Call : +91 0000000000
            </a>
          </div>
      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav  ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="bootstock.php"> Medicine </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="login.php"> Online Buy </a>
                                </li>
                                <li class="nav-item">
  ...
  <section class="container-fluid footer_section">
    <p>
      &copy; 2019 All Rights Reserved. Design by RISHI
    </p>
  </section>
  <!-- footer section -->
