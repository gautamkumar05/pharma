...
.t{position:absolute;bottom:5%;padding-top:3px;padding-bottom:3px;left:3%;width:94%; background-color:lightblue;text-align:center;color:black;}
.p{position:absolute;top:30%;left:8%;width:85%;height:40%;border:70%;padding-top:0px;padding-left:4px;background-color:lightgreen;
	...
	$sq=mysqli_query($cn,$q);
		...
		echo '<div class="col-md-4">';
			...
			echo '<br> STATUS :- '.$r['status'];
							...
							echo '<div class="t">';
							echo ' <br> Dealer and Retailer rate :- Rs. '.$r['drate'].' / Rs. '.$r['rrate'];
							echo '<br> Mfg Date :- '.$r['mfgdate']; echo '<br> Exp. Date :- '.$r['expdate'];
